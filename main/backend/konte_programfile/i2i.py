...
def create_background():
    ...
    with autocast("cuda"):
        init_image = Image.open(r"C:\ProgramFolder\branch\proed\main\backend\konte_programfile\projectfile\test\input.png").convert("RGB")
    ...
    image.save(r"C:\ProgramFolder\branch\proed\main\backend\konte_programfile\projectfile\test\imageSD.png")
