...
def create_background():
    ...
    with autocast("cuda"):
        init_image = Image.open(r"main\backend\konte_programfile\projectfile\test\input.png").convert("RGB")
    ...
    image.save(r"main\backend\konte_programfile\projectfile\test\imageSD.png")
